...
dateOfInterest <- as.Date(c("07-30-2024","07-31-2024","08-01-2024"), format = "%m-%d-%Y")
...
data_SOL <- read_csv("in/Solitaired/researchstudy-8-2-24-11-35 AM.csv")
data_TMB <- read_csv("in/TMB/solitairecog_data_20240802213231.csv")
